...
#define CUSTOM_MACHINE_NAME "BEnder-3 Pro"
...
//#define PSU_NAME "Power Supply"
  ...
  #define PSU_ACTIVE_STATE PSU_ACTIVE_STATE      // Set 'LOW' for ATX, 'HIGH' for X-Box
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 41.78
  #define DEFAULT_BED_KI 7.32
  #define DEFAULT_BED_KD 158.93
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -15, -1 }// (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
